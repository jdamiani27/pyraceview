...
class PerCarStatsData(object):
    def __init__(self, param1):
        self._id = param1.get_bits(BITS_CAR_NUM)
        self._top_speed = param1.get_bits(BITS_TOP_SPEED) / 100
        self._fastest_time = param1.get_bits(BITS_FASTEST_TIME)
        self._average_lap = param1.get_bits(BITS_AVERAGE_LAP)
        self._average_speed = param1.get_bits(BITS_AVERAGE_SPEED) / 100
