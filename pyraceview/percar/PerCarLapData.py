...
class PerCarLapData(object):
    ...
    def __init__(self, bit_buffer):
        self.car_id = int(bit_buffer.get_bits(self.LAPINFO_PER_CAR_BITS_CAR_NUMBER))
        ...
        self.laps_led = int(bit_buffer.get_bits(self.LAPINFO_PER_CAR_BITS_LAPS_LED))
        self.laps_in_top_10 = int(
            bit_buffer.get_bits(self.LAPINFO_PER_CAR_BITS_LAPS_IN_TOP_10)
        )
        self.rank = int(bit_buffer.get_bits(self.LAPINFO_PER_CAR_BITS_LAP))
