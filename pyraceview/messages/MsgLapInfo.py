...
class MsgLapInfo(object):
    def __init__(self, msg_bytes):
        ...
        self._vitc_time = int(bit_buffer.get_bits(LAPINFO_BITS_VITC_TIME))
        self._lap = int(bit_buffer.get_bits(LAPINFO_BITS_LAP))
        self._num_cars = int(bit_buffer.get_bits(LAPINFO_BITS_NUM_CARS))
        self._lead_changes = int(bit_buffer.get_bits(LAPINFO_BITS_LEAD_CHANGES))
        self._num_leaders = int(bit_buffer.get_bits(LAPINFO_BITS_NUM_LEADERS))
        self._num_cautions = int(bit_buffer.get_bits(LAPINFO_BITS_NUM_CAUTIONS))
        self._last_flag_change_lap = int(
            bit_buffer.get_bits(LAPINFO_BITS_FLAG_LAP)
        )
