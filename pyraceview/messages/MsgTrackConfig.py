...
class MsgTrackConfig(object):
    def __init__(self, msg_bytes):
        ...
        self._local_origin_x = int(bit_buffer.get_bits(TRACKCONFIG_BITS_ORIGIN_X))
        self._local_origin_y = int(bit_buffer.get_bits(TRACKCONFIG_BITS_ORIGIN_Y))
        self._local_origin_z = int(bit_buffer.get_bits(TRACKCONFIG_BITS_ORIGIN_Z))
