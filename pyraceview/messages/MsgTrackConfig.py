...
class MsgTrackConfig(object):
    ...
    def __init__(self, msg_bytes):
        ...
        self.local_origin_x = int(bit_buffer.get_bits(self.TRACKCONFIG_BITS_ORIGIN_X))
        self.local_origin_y = int(bit_buffer.get_bits(self.TRACKCONFIG_BITS_ORIGIN_Y))
        self.local_origin_z = int(bit_buffer.get_bits(self.TRACKCONFIG_BITS_ORIGIN_Z))
